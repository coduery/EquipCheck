...
namespace EquipCheck.EquipCheckLoginService {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="EquipCheckLoginServiceSoap", Namespace="http://tempuri.org/")]
    public partial class EquipCheckLoginService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public EquipCheckLoginService() {
            this.Url = global::EquipCheck.Properties.Settings.Default.EquipCheck_EquipCheckLoginService_EquipCheckLoginService;
        ...
        public EquipCheckAppUser AuthenticateUser(EquipCheckAppUser appUser) {
            object[] results = this.Invoke("AuthenticateUser", new object[] {
                        appUser});
            return ((EquipCheckAppUser)(results[0]));
        }
        
        /// <remarks/>
        public void AuthenticateUserAsync(EquipCheckAppUser appUser) {
            this.AuthenticateUserAsync(appUser, null);
        }
        
        /// <remarks/>
        public void AuthenticateUserAsync(EquipCheckAppUser appUser, object userState) {
            ...
            this.InvokeAsync("AuthenticateUser", new object[] {
                        appUser}, this.AuthenticateUserOperationCompleted, userState);
        }
    ...
    public partial class EquipCheckAppUser {
    ...
    public partial class AuthenticateUserCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        ...
        /// <remarks/>
        public EquipCheckAppUser Result {
            get {
                this.RaiseExceptionIfNecessary();
                return ((EquipCheckAppUser)(this.results[0]));
            }
        }
    }
}
